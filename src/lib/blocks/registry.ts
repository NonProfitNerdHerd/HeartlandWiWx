...
export const BLOCK_DEFINITIONS: BlockDefinition[] = [
	...
	{ type: 'hero', label: 'Cover', category: 'Basic', icon: '★', description: 'A hero section with title and background.', keywords: ['banner', 'cover'], defaultProps: { title: 'Hero Title', subtitle: '', image: '', align: 'center' } },
	{ type: 'splitHero', label: 'Split Cover', category: 'Basic', icon: '◧', description: 'Hero with side-by-side image and text.', keywords: ['split'], defaultProps: { title: 'Hero', image: '' } },
	{ type: 'minimalHero', label: 'Minimal Cover', category: 'Basic', icon: '—', description: 'A simple text-only hero section.', keywords: ['minimal'], defaultProps: { title: 'Hero' } },
	...
	{ type: 'twoColumns', label: 'Columns', category: 'Layout', icon: '▥', description: 'Add a block that displays content in columns.', keywords: ['column', 'grid'], defaultProps: { columns: 2 } },
	{ type: 'threeColumns', label: '3 Columns', category: 'Layout', icon: '▦', description: 'Three equal columns side by side.', keywords: ['column'], defaultProps: { columns: 3 } },
	{ type: 'fourColumns', label: '4 Columns', category: 'Layout', icon: '▩', description: 'Four equal columns side by side.', keywords: ['column'], defaultProps: { columns: 4 } },
